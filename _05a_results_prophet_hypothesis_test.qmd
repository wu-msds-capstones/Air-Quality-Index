...
![Figure 3: Prophet Trend and Prediction with 2020 Wildfire Season Highlight](https://github.com/wu-msds-capstones/Air-Quality-Index/blob/main/images/prophet_pdx_trend_and_prediction.png?raw=true)
...
To understand, we will conduct a Two-samples t-Test to see whether or not this month had greater than usual AQI.
...
![Figure 4: Wildfire Distribution](https://github.com/wu-msds-capstones/Air-Quality-Index/blob/main/images/normal_distribution_2_wildfires.png?raw=true)
...
![Figure 5: Prophet Component Trend Aggregations](https://github.com/wu-msds-capstones/Air-Quality-Index/blob/main/images/prophet_components_plot_aqi.png?raw=true)
...
![Figure 6: Prophet Error on Cross Validated Estimates](https://github.com/wu-msds-capstones/Air-Quality-Index/blob/main/images/prophet_cross_val_aqi.png?raw=true)
...
One hypothesis for Portland's better air quality outcomes is due to the increased focus on public transportation. Portland has placed high emphasis on utilizing public transit, with rates comparable to larger cities and higher than most other cities of its size. We will run a two-samples t-Test to see how Portland's rate of ridership compares with other large cities.

We have standardized rates by passenger miles ridden per person. This is the total number of miles ridden in a given year divided by the population. This allows us to properly compare cities with different population sizes.
...
![Figure 7: Transit Distribution](https://github.com/wu-msds-capstones/Air-Quality-Index/blob/main/images/normal_distribution_3_pdx_transit.png?raw=true)
