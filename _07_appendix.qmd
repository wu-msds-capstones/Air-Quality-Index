...
We have a new dataset metro_1mil.csv. This file was generated using a SQL statement that joins all relevant tables, filtering for metropolitan areas with populations less than or equal to 1 million. This approach limits our EDA to mid-sized metropolitan cities, such as Portland, Oregon.
...
#### Carbon Monoxide (CO), Wind and Air Quality Index (AQI)
...
#### Nitrogen Dioxide (NO2), Sulfur Dioxide (SO2) and Ozone (O₃)
