...
Running the models gives the output shown below in figure 12345. Random Forest model is the most accurate and will be used for the final model.
...
Figure 9999 below shows the selected hyperparameters.
...
Below, figure 111111 shows a classification report of the model. We can see that AQI groups from around 31-60 are strongest. We can attribute this to the higher amounts of data for these groups. To make the model more accurate, more data from AQI values outside this range will need to be collected.
...
We can also take a look at which features end up being most influential in the model. Below figure 1414 shows PM2.5 being by far the most influential variable in the model. Thus, we can focus more of our efforts on impacting the amount of PM2.5 in the air.
...
features = features[features['importance'] >= .05]
